from modules import TwoBetCalculate, Screen
...
class TwoSelections:
    ...
    def __init__(self):
        ...
        self.calculate = TwoBetCalculate()
        self.screen = Screen()
    ...
    def set_text_labels(self):
        ...
        bankroll_text_label.grid(row=2, column=4, padx=5, pady=10)  # Place label in grid with padding
        ...
        bet_size_text_label.grid(row=3, column=4, padx=5, pady=10)  # Place label in grid with padding
        ...
        calculate_text_label.grid(row=4, column=4, padx=5, pady=10)  # Place label in grid with padding
        ...
        pinnacle_vig_label.grid(row=0, column=4, padx=5, pady=10)  # Place label in grid with padding
        ...
        ev_vig_label.grid(row=1, column=4, padx=5, pady=10)  # Place label in grid with padding
        ...
        probability_text_label.grid(row=0, column=1, padx=5, pady=10)  # Place label in grid with padding

        true_odds_text_label = tk.Label(
            self.root,
        ...
        true_odds_text_label.grid(row=1, column=1, padx=5, pady=10)  # Place label in grid with padding
        ...
        fair_odds_text_label.grid(row=2, column=1, padx=5, pady=10)  # Place label in grid with padding
        ...
        ev_odds_text_label.grid(row=3, column=1, padx=5, pady=10)  # Place label in grid with padding
        ...
        ev_percentage_text_label.grid(row=4, column=1, padx=5, pady=10)  # Place label in grid with padding
        ...
        empty_label.grid(row=5, column=1, columnspan=3, padx=0, pady=20)  # Place label in grid with padding
        ...
        alt1_label.grid(row=6, column=1, columnspan=3, padx=10, pady=0)  # Span across all columns
        ...
        alt2_label.grid(row=7, column=1, columnspan=3, padx=10, pady=5)  # Span across all columns
    ...
    def set_data_labels(self):
        ...
        self.labels["pinnacle_vig"].grid(row=0, column=5, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["ev_vig"].grid(row=1, column=5, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["bet_size"].grid(row=3, column=5, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["probability1"].grid(row=0, column=2, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["probability2"].grid(row=0, column=3, padx=5, pady=10)  # Place label in grid with padding

        self.labels["true_odd1"] = tk.Label(
            self.root,
            text="0.000",  # Set text
            bg="#595959",  # Background color
            fg="#29c914",  # Text color
        ...
        self.labels["true_odd1"].grid(row=1, column=2, padx=5, pady=10)  # Place label in grid with padding

        self.labels["true_odd2"] = tk.Label(
            self.root,
            text="0.000",  # Set text
            bg="#595959",  # Background color
            fg="#29c914",  # Text color
        ...
        self.labels["true_odd2"].grid(row=1, column=3, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["fair_odd1"].grid(row=2, column=2, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["fair_odd2"].grid(row=2, column=3, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["ev_odd1"].grid(row=3, column=2, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["ev_odd2"].grid(row=3, column=3, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["ev_percentage1"].grid(row=4, column=2, padx=5, pady=10)  # Place label in grid with padding
        ...
        self.labels["ev_percentage2"].grid(row=4, column=3, padx=5, pady=10)  # Place label in grid with padding80

    def set_active_elements(self):
        self.labels["bankroll_text_box"] = tk.Text(self.root, height=1, width=10, font=("Typeface", 13))
        self.labels["bankroll_text_box"].grid(row=2, column=5, padx=5, pady=10)

        button_frame = tk.Frame(self.root)
        button_frame.grid(row=4, column=5, padx=10, pady=10)
        ...
        calculate_odd1_button.grid(row=0, column=1)
    ...
    def alt1_update(self):
        ...
        self.labels["true_odd1"].config(text=formatted_bet_data["pinnacle_odd1"])
        self.labels["true_odd2"].config(text=formatted_bet_data["pinnacle_odd2"])
    ...
    def alt1_function(self):
        ...
        self.bet_data["fair_odd1"], self.bet_data["fair_odd2"] = self.calculate.fair_odds(self.bet_data)
        self.bet_data["pinnacle_vig"] = self.calculate.pinnacle_vig(self.bet_data)
        self.bet_data["probability1"], self.bet_data["probability2"] = self.calculate.probability(self.bet_data)
    ...
    def alt2_function(self):
        ...
        self.bet_data["ev_percentage1"], self.bet_data["ev_percentage2"] = self.calculate.ev_percentage(self.bet_data)
